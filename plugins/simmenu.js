...
const fkgif = {
	 ...
	 message: { 
		"extendedTextMessage": {
                 "text":`Luminous MD 🌱 ┊ 𝗥𝗣𝗚 Whatsapp ʙᴏᴛ`,
                 "title": `Luminous MD 🌱 ┊ 𝗥𝗣𝗚 Whatsapp ʙᴏᴛ`,
 ...
 *Powered By @${'62895627514070'.split('@')[0]}*`
 ...
       const sections = [
                              {
                                "rows": [{
                                         ...
                                         "title": "⚡› Speed ",
                                         "description": "Menampilkan Kecepatan Respon カ LUMINOUS-MD",
                                         "rowId": ".ping"
                                    }, {
                                         "title": "🗒️› Info ",
 ...
           ] 
    const listMessage = {
      text: `Halo ${name} Pilih Menu Dibawah Ini Ya`.trim(),
      footer: ' Jangan Spam Ya Biar Ga Delay.',
      title: judul,
