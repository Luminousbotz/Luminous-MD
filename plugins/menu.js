...
%readmore`.trim(),
  header: '╭─㉿ 〔 ⚚ %category ⚚ 〕 ㉿─\n┃',
  body: '┃${emote} %cmd %islimit %isPremium',
  footer: '┃\n╰────────㉿\n', 
  after: `
⌕ ❙❘❙❙❘❙❚❙❘❙❙❚❙❙❘❙❙❘❙❘❙❚❙❘❙❙❙❘❙❘❙❚❙❘❙❚❙❘❙❙❘❙❚❙❘ ⌕.
 ...
 *Powered By @${'62895627514070'.split('@')[0]}*`
 ...
 const fload = {
    ...
    orderTitle: `▮Menu ▸`,
    thumbnail: await (await fetch('https://telegra.ph/file/2faa36c222a51b5acb9d7.jpg')).buffer(), //Gambarnye
 ...
 const ftroli = {
    ...
    status: 1,
    surface : 1,
    message: `Luminous Bot Made By Han QR`, 
    orderTitle: `▮Menu ▸`,
